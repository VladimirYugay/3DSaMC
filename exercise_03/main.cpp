...
int alignBunnyWithProcrustes() {
	...
	const std::string filenameSource = std::string("../../data/exercise_3_data/bunny_trans.off");
	const std::string filenameTarget = std::string("../../data/exercise_3_data/bunny.off");
